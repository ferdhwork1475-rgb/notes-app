        ...
        <div className="grid gap-14 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-6 leading-8 text-slate-400">
              {" "}
              Delivering trusted journalism, breaking news, politics, business,
              technology, sports, entertainment, and stories that matter.{" "}
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 flex flex-col gap-4">
              <Link className="text-slate-400 hover:text-white" to="/news">
                Politics
              </Link>
              <Link className="text-slate-400 hover:text-white" to="/news">
                Business
          ...
          <div>
            ...
            <div className="mt-6 space-y-5">
              <div className="flex gap-3">
                ...
                <span className="text-slate-400">watchmann96@gmail.com</span>
              </div>

              <div className="flex gap-3">
                <Phone size={18} className="mt-1 text-red-500" />
                <span className="text-slate-400">+234 802 707 3425</span>
              </div>
        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-slate-500">
              {" "}
              © {currentYear} WatchMann News. All Rights Reserved.{" "}
            </p>
          ...
          <div className="relative">
            <img
              ...
              className="h-[200px] w-full object-contain rounded-3xl shadow-2xl"
            />
          </div>
        </div>
      </div>
